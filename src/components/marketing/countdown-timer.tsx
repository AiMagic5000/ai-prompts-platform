  ...
  if (variant === 'card') {
    return (
      <motion.div
        ...
        className={`bg-white/5 border border-white/10 rounded-xl p-6 max-w-md mx-auto ${className}`}
      >
        ...
        {!isExpired ? (
          <>
            <p className="text-slate-400 mb-4 text-center text-sm">
              Purchase now and get <strong className="text-violet-400">500 EXTRA prompts FREE!</strong>
            </p>
  ...
  return (
    <div className="flex flex-col items-center">
      <motion.div
        ...
        animate={animate ? { scale: 1 } : undefined}
        className="w-16 h-16 bg-white/10 rounded-lg flex items-center justify-center border border-white/10"
      >
